...
Sitting with Kevin Zhang Derby under the shade of an orange tree by the Steward Observatory, I realized the monumental amount of preparation that goes into space instruments. Kevin’s job is to create computer models that simulate the performance of space instruments, testing whether their hardware and algorithms will actually work. Because space equipment is so expensive and time-consuming to build, these digital tests are a crucial first step.
